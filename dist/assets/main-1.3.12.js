import{B as rt,F as Ae,G as Re,H as Ke,A as Xe,u as fe,I as Rt,w as it,J as st,K as Nt,t as qt,r as Wt,M as Pt,N as Ht,P as Bt,Q as He,R as xe,S as Ft,T as jt,U as ct,q as le,i as Te,b as lt,C as Q,V as Le,W as dt,O as l,E as Be,l as ut,m as mt,x as pt,X as Gt,Y as ht,g as G,Z as yt,_ as Vt,z as Ut,$ as _t,a0 as Yt,a1 as Je,a2 as zt,a3 as Kt}from"./obrMetadataMigration-1.3.12.js";import{r as Xt,a as Jt}from"./contextMarkdown-1.3.12.js";function d(e){return e.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function w(e){return typeof e=="number"&&Number.isFinite(e)?String(e):""}function vt(e,t="",a="creature"){const n=E=>`${t}${E}`,o=e.scores??rt(),r=Ae(e.hpBase,o[2]),i=Re(e.loadBase,o[0]),s=r!==void 0&&e.hpMax!==r,c=i!==void 0&&e.maxLoad!==i,y=o.map((E,m)=>`
    ...
    <div class="encounter-combat">
      ...
      <span class="encounter-damage">${le("sword")}<span class="encounter-damage-copy">${o?`<button type="button" data-encounter-damage="${x(o)}">🎲 ${x(o)}</button>`:"—"}${r?`<span> (${x(r)})</span>`:""}${i?`<em>${x(i)}</em>`:""}</span></span>
...
• Someone important to you has been put in a bad spot as a result of your actions.`},{id:"bolster",name:"Bolster",text:"When you spend your leisure time in study, meditation, or hard practice, you gain preparation. If you prepare for a week or two, 1 preparation. If you prepare for a month or longer, 3 preparation. When your preparation pays off spend 1 preparation for +1 to any roll. You can only spend one preparation per roll."}];function re(e,t,a){return`
    ...
    </section>`}function ka(e,t,a,n=M,o="",r="",i=""){const s=t?"Default: visible to players":"Default: hidden from players";return`
    <section class="home">
    ...
    <section class="character-link-section">
      ...
      <label class="visibility">
        <input id="overwrite-label" type="checkbox" ${N?"checked":""} ${ce?"disabled":""}>
        Overwrite label
      </label>
      ${i}
    </section>`}function Dt(e){return e?`Copied from ${e.sourceName} · ${new Date(e.copiedAt).toLocaleString()}`:"No copied DWTools data."}function Ga(){const e=ye||D.status==="active";return`

import{z as De,B as ye,F as pe,G as Se,A as xe,r as te,H as Xe,v as Oe,q as qe,I as Ae,p as Je,t as Ze,J as Qe,K as et,M as tt,N as at,P as de,b as nt,n as ot,Q as Ne,O as d,E as ge,j as We,k as Pe,w as Re,R as rt,C as ae,S as Be,x as G,T as He,U as it,V as st,W as lt,X as Le,Y as ct,Z as dt}from"./obrMetadataMigration-1.3.1.js";function s(e){return e.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function v(e){return typeof e=="number"&&Number.isFinite(e)?String(e):""}function Fe(e,t="",a="creature"){const n=O=>`${t}${O}`,r=e.scores??De(),o=ye(e.hpBase,r[2]),i=pe(e.loadBase,r[0]),l=o!==void 0&&e.hpMax!==o,L=i!==void 0&&e.maxLoad!==i,D=r.map((O,c)=>`
...
• Someone important to you has been put in a bad spot as a result of your actions.`},{id:"bolster",name:"Bolster",text:"When you spend your leisure time in study, meditation, or hard practice, you gain preparation. If you prepare for a week or two, 1 preparation. If you prepare for a month or longer, 3 preparation. When your preparation pays off spend 1 preparation for +1 to any roll. You can only spend one preparation per roll."}];function me(e,t,a){return`
    ...
    <section class="character-link-section">
      ...
      ${i}
    </section>`}function y(){if(!m||!$)return;const e=Ve==="hp";Y.innerHTML=`

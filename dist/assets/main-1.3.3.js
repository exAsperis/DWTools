import{z as De,B as ye,F as pe,G as Se,A as xe,u as te,H as Xe,w as Oe,r as qe,I as Ae,J as Je,t as Ze,K as Qe,M as et,N as tt,P as at,Q as de,b as nt,q as ot,R as Ne,O as d,E as ge,l as We,m as Pe,x as Re,S as rt,C as ae,T as Be,g as G,U as He,V as it,W as st,X as lt,Y as Le,Z as ct,_ as dt}from"./obrMetadataMigration-1.3.3.js";function s(e){return e.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function v(e){return typeof e=="number"&&Number.isFinite(e)?String(e):""}function Fe(e,t="",a="creature"){const n=O=>`${t}${O}`,r=e.scores??De(),o=ye(e.hpBase,r[2]),i=pe(e.loadBase,r[0]),l=o!==void 0&&e.hpMax!==o,L=i!==void 0&&e.maxLoad!==i,D=r.map((O,c)=>`

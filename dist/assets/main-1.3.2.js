import{z as De,B as ye,F as pe,G as Se,A as xe,u as te,H as Xe,w as Oe,r as qe,I as Ae,c as Je,t as Ze,J as Qe,K as et,M as tt,N as at,P as de,b as nt,q as ot,Q as Ne,O as d,E as ge,l as We,m as Pe,x as Re,R as rt,C as ae,S as Be,g as G,T as He,U as it,V as st,W as lt,X as Le,Y as ct,Z as dt}from"./obrMetadataMigration-1.3.2.js";function s(e){return e.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function v(e){return typeof e=="number"&&Number.isFinite(e)?String(e):""}function Fe(e,t="",a="creature"){const n=O=>`${t}${O}`,r=e.scores??De(),o=ye(e.hpBase,r[2]),i=pe(e.loadBase,r[0]),l=o!==void 0&&e.hpMax!==o,L=i!==void 0&&e.maxLoad!==i,D=r.map((O,c)=>`

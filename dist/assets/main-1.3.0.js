import{y as De,z as ye,A as pe,B as Se,F as xe,G as te,H as Xe,I as Oe,q as qe,J as Ae,p as Je,t as Ze,K as Qe,M as et,N as tt,P as at,Q as de,b as nt,n as ot,R as We,O as d,E as ge,j as Ne,k as Pe,r as Re,S as rt,C as ae,T as Be,u as G,U as He,V as it,W as st,X as lt,Y as Le,Z as ct}from"./obrMetadataMigration-1.3.0.js";function s(e){return e.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function v(e){return typeof e=="number"&&Number.isFinite(e)?String(e):""}function Fe(e,t="",a="creature"){const n=O=>`${t}${O}`,r=e.scores??De(),o=ye(e.hpBase,r[2]),i=pe(e.loadBase,r[0]),l=o!==void 0&&e.hpMax!==o,L=i!==void 0&&e.maxLoad!==i,D=r.map((O,c)=>`
        <div class="ability-row">
          <label class="ability-score">${Se[c]}
            <span class="field-help">${xe[c]}</span>
            <input id="${n(`score-${c}`)}" name="score-${c}" type="number" min="3" max="18" step="1" value="${v(O)}">
          </label>
          <span class="ability-modifier" data-score-modifier="${c}" aria-label="${xe[c]} modifier">${Oe(Ae(O))}</span>
          <label class="condition-toggle">
            <input id="${n(`condition-${te[c]}`)}" name="condition-${te[c]}" type="checkbox" ${e.conditions?.[te[c]]===-1?"checked":""}>
            ${Xe[c]} <span>−1 ${Se[c]}</span>
          </label>
        </div>`).join("");return`
    ...
    </details>`}function dt(e){const t=e.fields;return`${s(t.name)} · HP ${v(t.hpCurrent)||"—"}/${v(t.hpMax)||"—"} · ARM ${v(t.armor)||"—"} · DMG ${s(t.damage??"—")}`}function ut(e){return`Delete the room character record "${e}"? Current-scene tokens will be unlinked and keep their creature fields. Linked copies in other scenes will become orphaned and need to be manually resolved.`}function mt(e){if(!e)return'<p class="manager-status">Metadata usage unavailable.</p>';const t=(e.bytes/1024).toFixed(1),a=(e.safeMaximumBytes/1024).toFixed(0);return`
    ...
    </div>`}function ht(e,t,a,n){const r=n.role==="GM"&&n.transfer?.sourceCharacterId===e.id&&n.transfer.sourceIndex===a;return`
    ...
    ${r?`<form class="transfer-form" data-transfer-form="${a}">
        ...
        </form>`:""}`}function yt(e,t){const a=e.inventory??[],n=Je(Ze(a),e.fields.maxLoad),r=t.expandedInventories?.has(e.id)??!1,o=!a.length&&e.fields.maxLoad===void 0?"Empty":qe(a,e.fields.maxLoad);return`
    <details class="inventory-section ${n?"overloaded":""}" data-inventory-details="${s(e.id)}" ${r?"open":""}>
      ...
      <div class="inventory-editor">
        <div class="inventory-list" aria-label="${s(e.fields.name)} inventory">
          ${a.length?a.map((i,l)=>ht(e,i,l,t)).join(""):'<p class="manager-status inventory-empty">No items.</p>'}
    ...
    </details>`}function pt(e,t){const a=t.expandedCharacters?.has(e.id)??!1,n=t.counts.get(e.id)??0;return`
    ...
    </details>`}function vt(e,t=!1){return e.editing?`
    ...
    <section class="character-manager">
      ...
      ${t?`${e.role==="GM"?mt(e.usage):""}
      ${e.role==="GM"?'<button type="button" class="primary compact manager-create" id="manager-create">New</button>':""}
      ${e.error?`<p class="inline-error">${s(e.error)}</p>`:""}
      ${e.loading?'<p class="manager-status">Loading Characters…</p>':e.records.length?`<div class="character-list">${e.records.map(a=>pt(a,e)).join("")}</div>`:`<p class="manager-status">${e.role==="GM"?"No Character records found.":"You do not currently control any linked Character tokens in this scene."}</p>`}`:""}
    </section>`}function ft(e,t){if(t.trim()!==""||e.trim()==="")return null;const a=Number(e);return Number.isFinite(a)&&a>=0?e.trim():null}function B(e,t){const a=String(e.get(t)??"").trim();if(!a)return;const n=Number(a);return Number.isFinite(n)?Math.trunc(n):void 0}function Me(e,t){const a=String(e.get(t)??"").trim();if(!a)return;const n=Number(a);return Number.isFinite(n)?n:void 0}function q(e,t){return String(e.get(t)??"").trim()||void 0}function gt(e,t,a){const n=a?{...t}:{};if(n.hpCurrent=B(e,"hpCurrent"),n.hpMax=B(e,"hpMax"),a)return n;n.tags=q(e,"tags"),n.hpBase=B(e,"hpBase"),n.maxLoad=Me(e,"maxLoad"),n.loadBase=B(e,"loadBase"),n.armor=B(e,"armor"),n.damage=q(e,"damage"),n.damageDescription=q(e,"damageDescription"),n.damageTags=q(e,"damageTags"),n.instinct=q(e,"instinct"),n.moves=q(e,"moves"),n.treasure=q(e,"treasure"),n.level=B(e,"level"),n.xp=B(e,"xp");const r=De();for(let i=0;i<r.length;i+=1)r[i]=Me(e,`score-${i}`)??null;n.scores=tt(r);const o={};for(const i of te)e.get(`condition-${i}`)==="on"&&(o[i]=-1);return n.conditions=at(o),n.alignment=q(e,"alignment"),n.visibleToPlayers=e.get("visibleToPlayers")==="on",n}function Ge(e,t,a){return{name:a?t.name:String(e.get("name")??"").trim(),...gt(e,t,a)}}function be(e){const t=e[de];return typeof t=="boolean"?t:!0}function bt(e,t){return nt(e)?e:{visibleToPlayers:t}}async function wt(e,t){await e({[de]:t})}const W={agenda:!0,moves:!0,basicMoves:!0,specialMoves:!1,settings:!1,characters:!1},Ye=[{id:"hack-and-slash",name:"Hack and Slash",text:"When you attack an enemy in melee, roll+Str. On a 10+ you deal your damage to the enemy and avoid their attack. At your option, you may choose to do +1d6 damage but expose yourself to the enemy’s attack. On a 7–9, you deal your damage to the enemy and the enemy makes an attack against you."},{id:"volley",name:"Volley",text:`When you take aim and shoot at an enemy at range, roll+Dex. On a 10+ you have a clear shot—deal your damage. On a 7–9, choose one (whichever you choose you deal your damage):
...
• Someone important to you has been put in a bad spot as a result of your actions.`},{id:"bolster",name:"Bolster",text:"When you spend your leisure time in study, meditation, or hard practice, you gain preparation. If you prepare for a week or two, 1 preparation. If you prepare for a month or longer, 3 preparation. When your preparation pays off spend 1 preparation for +1 to any roll. You can only spend one preparation per roll."}];function me(e,t,a){return`
    ...
    </section>`}function kt(e,t,a,n=W,r=""){const o=t?"Default: visible to players":"Default: hidden from players";return`
    <section class="home">
      ...
      <section class="home-section">
        ...
        ${Ee("Special Moves","specialMoves",n.specialMoves,je)}`:""}
      </section>
      ${e==="GM"?`<section class="home-section">
    ...
    </section>`}function Ie(e){const t=e[We];return typeof t=="boolean"?t:!0}async function $t(e,t){await e({[We]:t})}const Y=document.querySelector("#app"),J=new URLSearchParams(window.location.search),_=J.get("itemId"),Ue=J.get("view")??"edit",Te=J.get("preview");function oe(e){const t=document.documentElement;t.dataset.obrTheme=e.mode.toLowerCase(),t.style.setProperty("--dw-background",e.background.paper),t.style.setProperty("--dw-surface",e.background.default),t.style.setProperty("--dw-text",e.text.primary),t.style.setProperty("--dw-text-secondary",e.text.secondary),t.style.setProperty("--dw-text-disabled",e.text.disabled),t.style.setProperty("--dw-primary",e.primary.main)}function x(e,t){return e instanceof Error?e.message:t}function b(e,t){d.isAvailable&&d.notification.show(e,t)}function we(e){const t=e.elements.namedItem("damage");if(!(t instanceof HTMLInputElement))return!0;t.value=st(t.value);const a=lt(t.value);return t.classList.toggle("field-invalid",a),t.setAttribute("aria-invalid",String(a)),!a}function Ve(e){const t=e.elements.namedItem("damage");t instanceof HTMLInputElement&&t.addEventListener("blur",()=>we(e))}function C(e,t){const a=e.elements.namedItem(t);if(!(!(a instanceof HTMLInputElement)||a.value.trim()===""))return Number.isFinite(a.valueAsNumber)?a.valueAsNumber:void 0}function _e(e){const t=e.elements.namedItem("hpMax"),a=e.elements.namedItem("maxLoad"),n=e.querySelector("[data-calculated-hp]"),r=e.querySelector("[data-calculated-load]");if(!(t instanceof HTMLInputElement))return;const o=()=>{for(let D=0;D<6;D+=1){const O=C(e,`score-${D}`),c=e.querySelector(`[data-score-modifier="${D}"]`);c&&(c.textContent=Oe(Ae(O)))}const l=ye(C(e,"hpBase"),C(e,"score-2")),L=pe(C(e,"loadBase"),C(e,"score-0"));n&&(n.textContent=`Calculated: ${l??"—"}`),r&&(r.textContent=`Calculated: ${L??"—"}`),t.classList.toggle("calculation-mismatch",Le(C(e,"hpMax"),l)),a instanceof HTMLInputElement&&a.classList.toggle("calculation-mismatch",Le(C(e,"maxLoad"),L))},i=(l,L,D,O)=>{const c=e.elements.namedItem(l);!(c instanceof HTMLInputElement)||!(L instanceof HTMLInputElement)||(c.dataset.lastPromptedValue=c.value,c.addEventListener("blur",()=>{const ze=c.dataset.lastPromptedValue??"",ue=O();if(!ct(ze,c.value,C(e,L.name),ue)){c.dataset.lastPromptedValue=c.value,o();return}c.dataset.lastPromptedValue=c.value;const Ke=L.value.trim()||"blank";window.confirm(`${D} changed. Recalculate ${L.name==="hpMax"?"Maximum HP":"Maximum Load"} from ${Ke} to ${ue}?`)&&(L.value=String(ue)),o()}))};for(const l of e.querySelectorAll('[name^="score-"], [name="hpBase"], [name="loadBase"], [name="hpMax"], [name="maxLoad"]'))l.addEventListener("input",o);i("score-2",t,"Constitution",()=>ye(C(e,"hpBase"),C(e,"score-2"))),i("score-0",a,"Strength",()=>pe(C(e,"loadBase"),C(e,"score-0"))),o()}function Ct(e,t,a){const n=a?["hpCurrent","hpMax"]:["name","tags","hpCurrent","hpMax","hpBase","maxLoad","loadBase","armor","damage","damageDescription","damageTags","instinct","moves","treasure","level","xp","scores","conditions","alignment","visibleToPlayers"],r={};for(const o of n)JSON.stringify(e[o])!==JSON.stringify(t[o])&&(r[o]=t[o]);return r}let S="PLAYER",F={},ne=!1,V,re,f,j=[],ke=new Map,Q,ve=!1,E=!1,w,fe=!1,p,z,P;const ie=new Set,se=new Set,$e="dwtools/home-sections";function St(){try{const e=JSON.parse(localStorage.getItem($e)??"{}");return{agenda:typeof e.agenda=="boolean"?e.agenda:W.agenda,moves:typeof e.moves=="boolean"?e.moves:W.moves,basicMoves:typeof e.basicMoves=="boolean"?e.basicMoves:W.basicMoves,specialMoves:typeof e.specialMoves=="boolean"?e.specialMoves:W.specialMoves,settings:typeof e.settings=="boolean"?e.settings:W.settings,characters:typeof e.characters=="boolean"?e.characters:W.characters}}catch{return{...W}}}let N=St();function xt(){return{records:j,counts:ke,role:S,usage:Q,loading:ve,saving:E,error:w,editing:p,expandedCharacters:ie,expandedInventories:se,draftCharacterId:z,transfer:P}}function u(){const e=be(F),t=vt(xt(),N.characters||!!p);Y.innerHTML=kt(S,e,ne,N,t),document.querySelector("#default-visibility")?.addEventListener("click",()=>{Tt()});for(const a of document.querySelectorAll("[data-toggle-section]"))a.addEventListener("click",()=>{const n=a.dataset.toggleSection;N={...N,[n]:!N[n]},localStorage.setItem($e,JSON.stringify(N)),u()});for(const a of document.querySelectorAll("[data-move]"))a.addEventListener("click",()=>{const n=[...Ye,...je].find(l=>l.id===a.dataset.move),r=document.querySelector("#move-dialog"),o=document.querySelector("#move-dialog-title"),i=document.querySelector("#move-dialog-text");!n||!r||!o||!i||(o.textContent=n.name,i.textContent=n.text,r.showModal())});document.querySelector("#move-dialog-close")?.addEventListener("click",()=>document.querySelector("#move-dialog")?.close()),Lt()}function Lt(){document.querySelector("#manager-create")?.addEventListener("click",()=>{w=void 0,p={kind:"create",fields:{name:"Untitled character",visibleToPlayers:!0}},N.characters=!0,localStorage.setItem($e,JSON.stringify(N)),u()}),document.querySelector("#manager-cancel")?.addEventListener("click",()=>{p=void 0,w=void 0,u()});for(const t of document.querySelectorAll("[data-edit-character]"))t.addEventListener("click",()=>{const a=j.find(n=>n.id===t.dataset.editCharacter);a&&(w=void 0,p={kind:"edit",id:a.id,fields:a.fields},u())});for(const t of document.querySelectorAll("[data-delete-character]"))t.addEventListener("click",()=>{It(t.dataset.deleteCharacter)});const e=document.querySelector("#character-manager-form");e&&(Ve(e),_e(e),e.addEventListener("submit",t=>{t.preventDefault(),Et(e)}));for(const t of document.querySelectorAll("[data-character-details]"))t.addEventListener("toggle",()=>{const a=t.dataset.characterDetails;a&&(t.open?ie.add(a):ie.delete(a))});for(const t of document.querySelectorAll("[data-inventory-details]"))t.addEventListener("toggle",()=>{const a=t.dataset.inventoryDetails;a&&(t.open?se.add(a):se.delete(a))});Mt()}function A(e){const t=e.closest("[data-character-details]")?.dataset.characterDetails;return j.find(a=>a.id===t)}function U(e,t){const a=e.inventory?.[t];return a?{sourceIndex:t,expected:[...a]}:void 0}async function H(e,t,a){if(!E){E=!0,w=void 0,a?le(a):u();try{await e(),z=void 0,P=void 0,await T(!1),t&&b(t,"SUCCESS"),Q?.nearLimit&&b("Room metadata is approaching Owlbear's size limit.","WARNING")}catch(n){const r=x(n,"DWTools could not update this inventory.");await T(!1),w=r}finally{E=!1,a?le(a):u()}}}function le(e,t=!1){u(),window.requestAnimationFrame(()=>{const a=[...document.querySelectorAll("[data-character-details]")].find(r=>r.dataset.characterDetails===e);(a?.querySelector("[data-inventory-draft]")??a?.querySelector("[data-inventory-add]")??a?.querySelector("[data-inventory-details]"))?.scrollIntoView({block:"nearest"}),t&&a?.querySelector("[data-inventory-draft] [name=name]")?.focus()})}function he(e,t,a){e.addEventListener("keydown",n=>{n.key==="Escape"?(e.value=t,e.blur()):n.key==="Enter"&&(n.preventDefault(),e.blur())}),e.addEventListener("blur",a)}function Mt(){if(!f)return;for(const a of document.querySelectorAll("[data-inventory-name]")){const n=A(a),r=Number(a.dataset.inventoryName),o=n&&U(n,r);!n||!o||he(a,o.expected[0],()=>{if(a.value===o.expected[0])return;const i=[a.value,o.expected[1],o.expected[2]];H(()=>f.updateInventoryItem(n.id,o,i))})}for(const a of document.querySelectorAll("[data-inventory-weight]")){const n=A(a),r=Number(a.dataset.inventoryWeight),o=n&&U(n,r);if(!n||!o)continue;const i=String(o.expected[1]);he(a,i,()=>{if(a.value===i)return;const l=[o.expected[0],a.value.trim()===""?Number.NaN:Number(a.value),o.expected[2]];H(()=>f.updateInventoryItem(n.id,o,l))})}for(const a of document.querySelectorAll("[data-inventory-count]")){const n=A(a),r=Number(a.dataset.inventoryCount),o=n&&U(n,r);if(!n||!o)continue;const i=String(o.expected[2]);he(a,i,()=>{if(a.value===i)return;const l=a.value.trim()===""?Number.NaN:Number(a.value);H(()=>f.changeInventoryItemCount(n.id,o,l-o.expected[2]))})}for(const a of document.querySelectorAll("[data-inventory-adjust]"))a.addEventListener("click",()=>{const n=A(a),r=Number(a.dataset.inventoryAdjust),o=n&&U(n,r),i=Number(a.dataset.change);!n||!o||H(()=>f.changeInventoryItemCount(n.id,o,i))});for(const a of document.querySelectorAll("[data-inventory-remove]"))a.addEventListener("click",()=>{const n=A(a),r=Number(a.dataset.inventoryRemove),o=n&&U(n,r);!n||!o||H(()=>f.removeInventoryItem(n.id,o))});for(const a of document.querySelectorAll("[data-inventory-add]"))a.addEventListener("click",()=>{const n=A(a);n&&(z=n.id,ie.add(n.id),se.add(n.id),le(n.id,!0))});document.querySelector("[data-inventory-draft-cancel]")?.addEventListener("click",()=>{const a=z;z=void 0,a?le(a):u()});const e=document.querySelector("[data-inventory-draft]");e&&e.addEventListener("submit",a=>{a.preventDefault();const n=A(e);if(!n||!e.reportValidity())return;const r=new FormData(e),o=[String(r.get("name")??""),Number(r.get("weight")),Number(r.get("count"))];H(()=>f.addInventoryItem(n.id,o),void 0,n.id)});for(const a of document.querySelectorAll("[data-inventory-transfer]"))a.addEventListener("click",()=>{const n=A(a),r=Number(a.dataset.inventoryTransfer),o=n&&U(n,r);!n||!o||(P={sourceCharacterId:n.id,sourceIndex:r,expected:o.expected},u())});document.querySelector("[data-transfer-cancel]")?.addEventListener("click",()=>{P=void 0,u()});const t=document.querySelector("[data-transfer-form]");t&&P&&t.addEventListener("submit",a=>{if(a.preventDefault(),!P||!t.reportValidity())return;const n=new FormData(t),r=String(n.get("destination")??""),o=Number(n.get("count")),i=P;H(()=>f.transferInventoryItem(i.sourceCharacterId,r,{sourceIndex:i.sourceIndex,expected:i.expected},o),"Item transferred.")})}async function T(e=!0){if(!(!V||!re||!f)){ve=!0,w=void 0,e&&!p&&u();try{if(S==="GM"&&!fe){const t=await f.cleanupLegacyTombstones();fe=!0,t&&b(`Cleaned up ${t} legacy deleted character record${t===1?"":"s"}.`,"SUCCESS")}[j,ke,Q]=await Promise.all([f.listAccessible(),it(re.scene),S==="GM"?V.estimateUsage():Promise.resolve(void 0)]),S==="PLAYER"&&p?.kind==="edit"&&!j.some(t=>t.id===p?.id)&&(p=void 0,w="You no longer control a token linked to the Character being edited.")}catch(t){w=x(t,"DWTools could not load character records.")}finally{ve=!1,e&&!p&&u()}}}async function Et(e){if(!(!p||!f||E)){if(!we(e)||!e.reportValidity()){w="Correct the highlighted character fields before saving.",u();return}E=!0,w=void 0,u();try{const t=He(Ge(new FormData(e),p.fields,!1));p.kind==="create"?(await f.create(t),b("Character record created.","SUCCESS")):(await f.save(p.id,t),b("Character record saved.","SUCCESS")),p=void 0,await T(!1),Q?.nearLimit&&b("Room metadata is approaching Owlbear's size limit.","WARNING")}catch(t){w=x(t,"DWTools could not save the record.")}finally{E=!1,u()}}}async function It(e){if(!e||!f||E)return;const t=j.find(a=>a.id===e);if(t&&window.confirm(ut(t.fields.name))){E=!0,w=void 0,u();try{await f.delete(e),b("Character record deleted. Other-scene copies are now orphaned.","SUCCESS"),await T(!1)}catch(a){w=x(a,"DWTools could not delete the record.")}finally{E=!1,u()}}}async function Tt(){if(S!=="GM"||ne)return;const e=!be(F);ne=!0,u();try{await wt(t=>d.room.setMetadata(t),e),F={...F,[de]:e}}catch(t){console.error("DWTools could not save the default overlay visibility",t),b("DWTools could not save the default overlay visibility.","ERROR")}finally{ne=!1,u()}}async function Dt(){try{await Ne()}catch(t){console.error("DWTools metadata namespace migration failed",t),Y.innerHTML='<p class="error">DWTools could not migrate its saved data. Reload Owlbear and try again.</p>',b("DWTools could not migrate its saved data.","ERROR");return}V=Pe(),re=Re(V),f=rt(V,re),[S,F]=await Promise.all([d.player.getRole(),d.room.getMetadata(),d.theme.getTheme().then(oe)]),await T(!1),u();const e=[d.room.onMetadataChange(t=>{F=t,u()}),V.subscribe(t=>{t.some(a=>a.lookup.status==="deleted")&&(fe=!1),T(S==="PLAYER"||!p)}),d.player.onChange(t=>{S=t.role,p=void 0,z=void 0,P=void 0,T()}),d.scene.items.onChange(()=>{T(S==="PLAYER"||!p)}),d.room.onPermissionsChange(()=>{T(S==="PLAYER"||!p)}),d.theme.onChange(oe)];window.addEventListener("unload",()=>{for(const t of e)t()},{once:!0})}let R,k,m,$,M={status:"missing"},ce=[],ee=!1,K="",h=!1,I=!0,X=!1,g,Ce=!1;function Ot(e){const t=G(e);let a,n;t?M.status==="active"?(a=`Character record: <strong>${s(M.record.fields.name)}</strong>`,n=`
    ...
    <section class="character-link-section">
      ...
      ${i}
    </section>`}function y(){if(!m||!$)return;const e=Ue==="hp";Y.innerHTML=`
    ...
    </form>`;const t=document.querySelector("#creature-form"),a=t.elements.namedItem("hpCurrent"),n=t.elements.namedItem("hpMax");a.addEventListener("blur",()=>{const r=ft(a.value,n.value);r!==null&&(n.value=r)}),Ve(t),_e(t);for(const r of t.querySelectorAll("[data-hp]"))r.addEventListener("click",()=>{a.value=String((Number(a.value)||0)+Number(r.dataset.hp))});document.querySelector("#close")?.addEventListener("click",()=>{d.popover.close(ge)}),document.querySelector("#remove")?.addEventListener("click",()=>{Rt()}),document.querySelector("#link-character")?.addEventListener("click",()=>{qt()}),document.querySelector("#overwrite-label")?.addEventListener("change",r=>{At(r.currentTarget.checked)});for(const r of document.querySelectorAll("#create-character"))r.addEventListener("click",()=>{Nt()});document.querySelector("#unlink-character")?.addEventListener("click",()=>{Pt()}),document.querySelector("#cancel-link")?.addEventListener("click",()=>{ee=!1,K="",y()}),document.querySelector("#link-search")?.addEventListener("input",r=>{K=r.currentTarget.value;const o=K.trim().toLocaleLowerCase();for(const i of document.querySelectorAll("[data-link-search]"))i.hidden=!String(i.dataset.linkSearch).includes(o)});for(const r of document.querySelectorAll("[data-link-record]"))r.addEventListener("click",()=>{Wt(r.dataset.linkRecord)});t.addEventListener("submit",r=>{r.preventDefault(),Bt(t)})}async function Z(){if(!_||!k||!R)return;const e=await k.getItem(_);if(!e){Y.innerHTML='<p class="error">That token is no longer in the scene.</p>';return}Ce=ae in e.metadata,m=e,$=Be(e);const t=G(e);M=t?await R.inspect(t.characterId):{status:"missing"},M.status==="active"&&($=M.record.fields),y()}async function qt(){if(!(!R||h)){h=!0,g=void 0,y();try{ce=await R.list(),ee=!0}catch(e){g=x(e,"DWTools could not load character records.")}finally{h=!1,y()}}}async function At(e){if(X)return;const t=I;I=e,X=!0,y();try{await $t(a=>d.room.setMetadata(a),e)}catch(a){I=t,g=x(a,"DWTools could not save the overwrite-label setting.")}finally{X=!1,y()}}async function Wt(e){if(!e||!k||!m||h)return;const t=ce.find(a=>a.id===e);if(t&&window.confirm(`Link to "${t.fields.name}"? This token's current DWTools creature data will be replaced by the latest character record. Its label will be ${I?"overwritten":"retained"}.`)){h=!0,g=void 0,y();try{await k.linkToExistingCharacter(m.id,e,I),b(`Linked to ${t.fields.name}.`,"SUCCESS"),ee=!1,await Z()}catch(a){g=x(a,"DWTools could not link the character.")}finally{h=!1,y()}}}async function Nt(){if(!(!k||!m||h)){h=!0,g=void 0,y();try{const{record:e}=await k.createAndLinkCharacter(m.id);b(`Created and linked ${e.fields.name}.`,"SUCCESS"),ee=!1,await Z()}catch(e){g=x(e,"DWTools could not create and link the character.")}finally{h=!1,y()}}}async function Pt(){if(!(!k||!m||h)){h=!0,g=void 0,y();try{await k.unlinkCharacter(m.id),b("Character unlinked; creature fields were retained.","SUCCESS"),await Z()}catch(e){g=x(e,"DWTools could not unlink the character.")}finally{h=!1,y()}}}async function Rt(){if(!(!k||!m||h||G(m)&&!window.confirm("Remove this token's DWTools data? The token will be unlinked, but the room character record will be preserved."))){h=!0,y();try{await k.removeCreatureData(m.id),await d.popover.close(ge)}catch(t){g=x(t,"DWTools could not remove the creature data."),h=!1,y()}}}async function Bt(e){if(!(!k||!m||!$||h)){if(!we(e)||!e.reportValidity()){g="Correct the highlighted creature fields before saving.",y();return}h=!0,g=void 0,y();try{const t=Ue==="hp",a=He(Ge(new FormData(e),$,t));let n=Ct($,a,t);!Ce&&!G(m)&&(n=a),Object.keys(n).length&&await k.updateCreatureFields(m.id,n),b(G(m)?"Character record saved.":"Creature saved.","SUCCESS"),await d.popover.close(ge)}catch(t){g=x(t,"DWTools could not save the creature."),h=!1,y()}}}async function Ht(){if(!_)return;try{await Ne()}catch(o){console.error("DWTools metadata namespace migration failed",o),Y.innerHTML='<p class="error">DWTools could not migrate its saved data. Reload Owlbear and try again.</p>',b("DWTools could not migrate its saved data.","ERROR");return}R=Pe(),k=Re(R);const[e,t]=await Promise.all([k.getItem(_),d.room.getMetadata().catch(o=>(console.warn("DWTools could not load room visibility settings",o),{})),d.theme.getTheme().then(oe)]);if(!e){Y.innerHTML='<p class="error">That token is no longer in the scene.</p>';return}Ce=ae in e.metadata;const a=bt(e.metadata[ae],be(t));I=Ie(t),m={...e,metadata:{...e.metadata,[ae]:a}},$=Be(m);const n=G(m);M=n?await R.inspect(n.characterId):{status:"missing"},M.status==="active"&&($=M.record.fields),y();const r=[R.subscribe(o=>{const i=m&&G(m);i&&o.some(l=>l.characterId===i.characterId)&&!h&&Z()}),d.scene.items.onChange(o=>{o.find(l=>l.id===_)&&!h&&Z()}),d.room.onMetadataChange(o=>{X||(I=Ie(o),y())}),d.theme.onChange(oe)];window.addEventListener("unload",()=>{for(const o of r)o()},{once:!0})}Te==="home"?(S="GM",F={[de]:J.get("default")!=="hidden"},j=[{schemaVersion:3,id:"preview-active",fields:{name:"Raganah",hpCurrent:8,hpMax:10,armor:1,damage:"d8+2",tags:"Cautious, Loyal"},revision:3,createdAt:"2026-07-25T15:00:00.000Z",createdBy:"preview-gm",updatedAt:"2026-07-26T15:00:00.000Z",updatedBy:"preview-gm",writeId:"preview-active-write"}],ke=new Map([["preview-active",2]]),Q={bytes:7168,limitBytes:16384,safeMaximumBytes:15360,warningBytes:13107,nearLimit:!1,percentOfLimit:43.75},u()):Te==="editor"?(I=J.get("overwriteLabel")?.toLocaleLowerCase()!=="false",m={id:"preview",name:"Frogman",metadata:{}},$={name:"Frogman",hpCurrent:7,hpMax:10,tags:"Solitary, Small, Intelligent, Stealthy, Devious",armor:1,damage:"b[2d6]+1",damageDescription:"Claws",damageTags:"Close, Messy",instinct:"To defend the drowned temple",moves:`Strike from beneath the water
Call the marsh to its aid`,treasure:"A waterlogged purse and a silver idol"},y()):_?d.isAvailable?d.onReady(()=>{Ht()}):Y.innerHTML='<p class="error">Open this editor from a token inside Owlbear Rodeo.</p>':(u(),d.isAvailable&&d.onReady(()=>{Dt()}));

import{B as rt,F as Re,G as Ae,H as Ke,A as Xe,u as fe,I as At,w as it,J as st,K as Nt,t as qt,r as Wt,M as Pt,N as Ht,P as Bt,Q as He,R as xe,S as Ft,T as jt,U as ct,q as ce,i as Te,b as lt,C as Q,V as Le,W as dt,O as l,E as Be,l as ut,m as mt,x as pt,X as Gt,Y as ht,g as G,Z as yt,_ as Vt,z as Ut,$ as _t,a0 as Yt,a1 as Je,a2 as zt,a3 as Kt}from"./obrMetadataMigration-1.3.10.js";import{r as Xt,a as Jt}from"./contextMarkdown-1.3.10.js";function d(e){return e.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function w(e){return typeof e=="number"&&Number.isFinite(e)?String(e):""}function vt(e,t="",a="creature"){const n=E=>`${t}${E}`,o=e.scores??rt(),r=Re(e.hpBase,o[2]),i=Ae(e.loadBase,o[0]),s=r!==void 0&&e.hpMax!==r,c=i!==void 0&&e.maxLoad!==i,y=o.map((E,m)=>`
  ...
  </article>`}function fa(e,t,a,n=new Set){const{active:o,inactive:r}=je(e,t);return`<div class="encounter-list" data-encounter-active-list>${o.length?o.map(i=>va(i,n)).join(""):'<p class="encounter-empty">No active DWTools creatures in this scene.</p>'}</div>
...
• Someone important to you has been put in a bad spot as a result of your actions.`},{id:"bolster",name:"Bolster",text:"When you spend your leisure time in study, meditation, or hard practice, you gain preparation. If you prepare for a week or two, 1 preparation. If you prepare for a month or longer, 3 preparation. When your preparation pays off spend 1 preparation for +1 to any roll. You can only spend one preparation per roll."}];function ye(e,t,a){return`
    ...
    </section>`}function $a(e,t,a,n=T,o="",r="",i=""){const s=t?"Default: visible to players":"Default: hidden from players";return`
    <section class="home">
    ...
    <section class="character-link-section">
      ...
      ${i}
    </section>`}function Dt(e){return e?`Copied from ${e.sourceName} · ${new Date(e.copiedAt).toLocaleString()}`:"No copied DWTools data."}function ja(){const e=he||D.status==="active";return`
    ...
    </form>`;const t=document.querySelector("#creature-form"),a=t.elements.namedItem("hpCurrent"),n=t.elements.namedItem("hpMax");a.addEventListener("blur",()=>{const o=ca(a.value,n.value);o!==null&&(n.value=o)}),Mt(t),Tt(t);for(const o of t.querySelectorAll("[data-hp]"))o.addEventListener("click",()=>{a.value=String((Number(a.value)||0)+Number(o.dataset.hp))});document.querySelector("#close")?.addEventListener("click",()=>{l.popover.close(Be)}),document.querySelector("#remove")?.addEventListener("click",()=>{Za()}),document.querySelector("#copy-creature-data")?.addEventListener("click",()=>Ga()),document.querySelector("#paste-creature-data")?.addEventListener("click",()=>_a(t)),document.querySelector("#clear-creature-data")?.addEventListener("click",()=>Va()),document.querySelector("#link-character")?.addEventListener("click",()=>{Ya()}),document.querySelector("#overwrite-label")?.addEventListener("change",o=>{za(o.currentTarget.checked)});for(const o of document.querySelectorAll("#create-character"))o.addEventListener("click",()=>{Xa()});document.querySelector("#unlink-character")?.addEventListener("click",()=>{Ja()}),document.querySelector("#cancel-link")?.addEventListener("click",()=>{pe=!1,ie="",g()}),document.querySelector("#link-search")?.addEventListener("input",o=>{ie=o.currentTarget.value;const r=ie.trim().toLocaleLowerCase();for(const i of document.querySelectorAll("[data-link-search]"))i.hidden=!String(i.dataset.linkSearch).includes(r)});for(const o of document.querySelectorAll("[data-link-record]"))o.addEventListener("click",()=>{Ka(o.dataset.linkRecord)});t.addEventListener("submit",o=>{o.preventDefault(),Qa(t)})}function ze(){const e=document.querySelector("[data-clipboard-status]");e&&(e.textContent=Dt(q));const t=document.querySelector("#paste-creature-data"),a=document.querySelector("#clear-creature-data");t&&(t.disabled=!q),a&&(a.disabled=!q)}function Ga(){if(!p||!f||!he&&D.status!=="active"){h("This token has no saved DWTools data to copy.","WARNING");return}try{const e=gt(He(f),p.name);ra(window.localStorage,e),q=e,ze(),h(`Copied DWTools data from ${e.sourceName}.`,"SUCCESS")}catch(e){h(C(e,"DWTools could not copy the creature data."),"ERROR")}}function Va(){try{sa(window.localStorage),q=void 0,ze(),h("Copied DWTools data cleared.","SUCCESS")}catch(e){h(C(e,"DWTools could not clear the copied data."),"ERROR")}}function Ua(e){if(!f)return!1;try{const t=xe(Fe(new FormData(e),f,!1));return JSON.stringify(t)!==JSON.stringify(f)}catch{return!0}}function _a(e){if(!p||!f)return;if(G(p)){h("Unlink this token from its Character record before pasting DWTools data.","ERROR");return}const t=bt(window.localStorage);if(q=t,!t){ze(),h("There is no valid copied DWTools data to paste.","WARNING");return}Ua(e)&&!window.confirm("Replace the unsaved form values with the copied DWTools data?")||(f=ia(f.name,t),oe=t,S=void 0,g())}async function ue(){if(!ee||!I||!F)return;const e=await I.getItem(ee);if(!e){K.innerHTML='<p class="error">That token is no longer in the scene.</p>';return}he=Q in e.metadata,oe=void 0,p=e,f=ht(e);const t=G(e);D=t?await F.inspect(t.characterId):{status:"missing"},D.status==="active"&&(f=D.record.fields),g()}async function Ya(){if(!(!F||v)){v=!0,S=void 0,g();try{Ee=await F.list(),pe=!0}catch(e){S=C(e,"DWTools could not load character records.")}finally{v=!1,g()}}}async function za(e){if(se)return;const t=N;N=e,se=!0,g();try{await ka(a=>l.room.setMetadata(a),e)}catch(a){N=t,S=C(a,"DWTools could not save the overwrite-label setting.")}finally{se=!1,g()}}async function Ka(e){if(!e||!I||!p||v)return;const t=Ee.find(a=>a.id===e);if(t&&window.confirm(`Link to "${t.fields.name}"? This token's current DWTools creature data will be replaced by the latest character record. Its label will be ${N?"overwritten":"retained"}.`)){v=!0,S=void 0,g();try{await I.linkToExistingCharacter(p.id,e,N),h(`Linked to ${t.fields.name}.`,"SUCCESS"),pe=!1,await ue()}catch(a){S=C(a,"DWTools could not link the character.")}finally{v=!1,g()}}}async function Xa(){if(!(!I||!p||v)){v=!0,S=void 0,g();try{const{record:e}=await I.createAndLinkCharacter(p.id);h(`Created and linked ${e.fields.name}.`,"SUCCESS"),pe=!1,await ue()}catch(e){S=C(e,"DWTools could not create and link the character.")}finally{v=!1,g()}}}async function Ja(){if(!(!I||!p||v)){v=!0,S=void 0,g();try{await I.unlinkCharacter(p.id),h("Character unlinked; creature fields were retained.","SUCCESS"),await ue()}catch(e){S=C(e,"DWTools could not unlink the character.")}finally{v=!1,g()}}}async function Za(){if(!(!I||!p||v||G(p)&&!window.confirm("Remove this token's DWTools data? The token will be unlinked, but the room character record will be preserved."))){v=!0,g();try{await I.removeCreatureData(p.id),await l.popover.close(Be)}catch(t){S=C(t,"DWTools could not remove the creature data."),v=!1,g()}}}async function Qa(e){if(!(!I||!p||!f||v)){if(!Ue(e)||!e.reportValidity()){S="Correct the highlighted creature fields before saving.",g();return}v=!0,S=void 0,g();try{const t=Lt==="hp",a=xe(Fe(new FormData(e),f,t)),n=!!oe;if(n)await I.replaceUnlinkedCreatureData(p.id,He(a)),oe=void 0;else{let o=Sa(f,a,t);!he&&!G(p)&&(o=a),Object.keys(o).length&&await I.updateCreatureFields(p.id,o)}h(n?"Copied DWTools data saved.":G(p)?"Character record saved.":"Creature saved.","SUCCESS"),await l.popover.close(Be)}catch(t){S=C(t,"DWTools could not save the creature."),v=!1,g()}}}async function en(){if(!ee)return;try{await ut()}catch(r){console.error("DWTools metadata namespace migration failed",r),K.innerHTML='<p class="error">DWTools could not migrate its saved data. Reload Owlbear and try again.</p>',h("DWTools could not migrate its saved data.","ERROR");return}F=mt(),I=pt(F),q=bt(window.localStorage);const[e,t]=await Promise.all([I.getItem(ee),l.room.getMetadata().catch(r=>(console.warn("DWTools could not load room visibility settings",r),{})),l.theme.getTheme().then(ke)]);if(!e){K.innerHTML='<p class="error">That token is no longer in the scene.</p>';return}he=Q in e.metadata;const a=ga(e.metadata[Q],Ve(t));N=et(t),p={...e,metadata:{...e.metadata,[Q]:a}},f=ht(p);const n=G(p);D=n?await F.inspect(n.characterId):{status:"missing"},D.status==="active"&&(f=D.record.fields),g();const o=[F.subscribe(r=>{const i=p&&G(p);i&&r.some(s=>s.characterId===i.characterId)&&!v&&ue()}),l.scene.items.onChange(r=>{r.find(s=>s.id===ee)&&!v&&ue()}),l.room.onMetadataChange(r=>{se||(N=et(r),g())}),l.theme.onChange(ke)];window.addEventListener("unload",()=>{for(const r of o)r()},{once:!0})}tt==="home"?(k="GM",_={[Le]:de.get("default")!=="hidden"},X=[{schemaVersion:3,id:"preview-active",fields:{name:"Raganah",hpCurrent:8,hpMax:10,armor:1,damage:"d8+2",tags:"Cautious, Loyal"},revision:3,createdAt:"2026-07-25T15:00:00.000Z",createdBy:"preview-gm",updatedAt:"2026-07-26T15:00:00.000Z",updatedBy:"preview-gm",writeId:"preview-active-write"}],_e=new Map([["preview-active",2]]),me={bytes:7168,limitBytes:16384,safeMaximumBytes:15360,warningBytes:13107,nearLimit:!1,percentOfLimit:43.75},u()):tt==="editor"?(N=de.get("overwriteLabel")?.toLocaleLowerCase()!=="false",p={id:"preview",name:"Frogman",metadata:{}},f={name:"Frogman",hpCurrent:7,hpMax:10,tags:"Solitary, Small, Intelligent, Stealthy, Devious",armor:1,damage:"b[2d6]+1",damageDescription:"Claws",damageTags:"Close, Messy",instinct:"To defend the drowned temple",moves:`Strike from beneath the water
Call the marsh to its aid`,treasure:"A waterlogged purse and a silver idol"},g()):ee?l.isAvailable?l.onReady(()=>{en()}):K.innerHTML='<p class="error">Open this editor from a token inside Owlbear Rodeo.</p>':(u(),l.isAvailable&&l.onReady(()=>{Ba()}));

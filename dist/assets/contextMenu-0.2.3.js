import{O as a,C as c,i as g,f as h}from"./constants-0.2.3.js";import{p as w,f as T,r as R}from"./damage-0.2.3.js";import{a as E}from"./icons-0.2.3.js";const n=document.querySelector("#context-menu"),P=new URL("./",window.location.href);let s,l=!1;function y(e){return e.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function r(e){const t=e.metadata[c];return g(t)?t:{}}function o(e){return e===void 0||e===""?"—":y(String(e))}function u(e){const t=document.documentElement;t.dataset.obrTheme=e.mode.toLowerCase(),t.style.setProperty("--dw-text",e.text.primary),t.style.setProperty("--dw-text-secondary",e.text.secondary),t.style.setProperty("--dw-primary",e.primary.main)}function f(){if(!s){n.innerHTML='<p class="loading">Select one character token.</p>';return}const e=r(s),t=(e.moves??"").split(/\r?\n/).map(i=>i.trim()).filter(Boolean);n.innerHTML=`
    <section class="panel">
      <div class="stats">

import{q as C,t as H,e as B,r as N,u as E,v as q,A as F,w as W,O as r,l as U,m as X,x as j,g as I,C as P,b as _,y as V,E as Y,z as Z}from"./obrMetadataMigration-1.3.12.js";import{r as T,a as z}from"./contextMarkdown-1.3.12.js";function v(e){return e.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function S(e,t,o){const n=[];for(let s=t;s<o;s+=1){const y=e.conditions?.[E[s]]===-1,c=q(e.scores?.[s],e.conditions?.[E[s]]);if(c===void 0)continue;const l=W(c);n.push(`

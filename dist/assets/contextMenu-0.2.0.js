import{O as i,C as c,i as y,c as g}from"./constants-0.2.0.js";import{p as h,f as w,r as R}from"./damage-0.2.0.js";const s=document.querySelector("#context-menu"),S=new URL("./",window.location.href);let n,l=!1;function m(e){return e.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function r(e){const t=e.metadata[c];return y(t)?t:{}}function o(e){return e===void 0||e===""?"—":m(String(e))}function f(){if(!n){s.innerHTML='<p class="loading">Select one character token.</p>';return}const e=r(n),t=(e.moves??"").split(/\r?\n/).map(a=>a.trim()).filter(Boolean);s.innerHTML=`
    <section class="panel">
      <div class="stats">
